...
class HomeView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Router.anchorRoute);
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/test.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/location.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/confirm.js":[function(require,module,exports) {
"use strict";
...
class ConfirmView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, _Auth.default.currentUser.lastName, _Router.anchorRoute);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new ConfirmView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/receipt.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Receipt\" user=\"", "\"></va-app-header>\n      <img src=\"./images/background2.jpg\" alt=\"background\" class=\"back\">\n\n    <style>\n\n    \n\n    </style>\n\n\n      <div class=\"page-content page-centered\">      \n      <div class=\"container3\">  \n      <form id=\"contact\" action=\"\" method=\"post\">\n        <p class=\"typo2\">Thank You, ", "</p>\n        <br>\n        <p class=\"typo\"><b>Order Placed!</b></p>\n        <br>\n       <p class=\"typo\">Ref: #225104</p>\n       <br>\n       \n\n        \n  \n  <sl-button  href=\"https://drive.google.com/file/d/1U4-fXkQOqTUMb-6_bHfZv3U-2sMNeejb/view\"\n  \n  class=\"length\" type=\"success\" submit>Download your Receipt</sl-button>\n\n\n\n  <div class=\"typo3\">\n\n  <a href=\"/\" @click=", ">\n \n  \n\n  <p>Back to Home<i class=\"arrow right\"></i></p>\n\n  </a>\n\n  </div>\n\n</sl-form>\n       \n      </form>\n      </div>\n      \n      \n        \n      \n\n\n\n\n<style>\n\n.typo3{\n  padding-top:15px;\n  color: #000;\n  text-align: center;\n}\n\n\n\n.arrow {\n  color: #fff;\n  border: solid black;\n  border-width: 0 3px 3px 0;\n  display: inline-block;\n  padding: 3px;\n}\n\n.right {\n  color: #fff;\n  transform: rotate(-45deg);\n  -webkit-transform: rotate(-45deg);\n}\n\n\n.typo2{\n  font-family: 'Pineapple Demo', cursive;\n  color: #000;\n  text-align:center;\n  font-size: 50px;\n}\n\n\n.length{\n  width:100%;\n}\n\n\n.input-validation-type{\n\n  color: #000;\n\n}\n\n.typo{\n  color: #000;\n  text-align:center;\n}\n\n.back{\n\n \n  width:auto;\n  height:125%;\n\n}\n\n\n.container3 {\n  max-width: 400px;\n  width: 100%;\n  margin: 0 auto;\n  position: relative;\n}\n\n#contact input[type=\"text\"],\n#contact input[type=\"email\"],\n#contact input[type=\"tel\"],\n#contact textarea,\n#contact button[type=\"submit\"] {\n  font: 400 12px/16px \"Roboto\", Helvetica, Arial, sans-serif;\n}\n\n#contact {\n  background: #F9F9F9;\n  padding: 25px;\n  margin: 150px 0;\n  box-shadow: 0 0 20px 0 rgba(0, 0, 0, 0.2), 0 5px 5px 0 rgba(0, 0, 0, 0.24);\n}\n\n#contact h1 {\n  font-family: 'Pineapple Demo', cursive;\n  text-align:center;\n  color: #000;\n  display: block;\n  font-size: 30px;\n  font-weight: 300;\n  margin-bottom: 10px;\n}\n\n#contact h4 {\n  color: #000;\n  margin: 5px 0 15px;\n  text-align:center;\n  display: block;\n  font-size: 13px;\n  font-weight: 400;\n}\n\nfieldset {\n  border: medium none !important;\n  margin: 0 0 10px;\n  min-width: 100%;\n  padding: 0;\n  width: 100%;\n}\n\n#contact input[type=\"text\"],\n#contact input[type=\"email\"],\n#contact input[type=\"tel\"],\n#contact textarea {\n  width: 100%;\n  border: 1px solid #ccc;\n  background: #FFF;\n  margin: 0 0 5px;\n  padding: 10px;\n}\n\n#contact input[type=\"text\"]:hover,\n#contact input[type=\"email\"]:hover,\n#contact input[type=\"tel\"]:hover,\n#contact textarea:hover {\n  -webkit-transition: border-color 0.3s ease-in-out;\n  -moz-transition: border-color 0.3s ease-in-out;\n  transition: border-color 0.3s ease-in-out;\n  border: 1px solid #aaa;\n}\n\n#contact textarea {\n  height: 100px;\n  max-width: 100%;\n  resize: none;\n}\n\n#contact button[type=\"submit\"] {\n  cursor: pointer;\n  width: 100%;\n  border: none;\n  background: #6f4e37;\n  color: #FFF;\n  margin: 0 0 5px;\n  padding: 10px;\n  font-size: 15px;\n}\n\n#contact button[type=\"submit\"]:hover {\n  background: #43A047;\n  -webkit-transition: background 0.3s ease-in-out;\n  -moz-transition: background 0.3s ease-in-out;\n  transition: background-color 0.3s ease-in-out;\n}\n\n#contact button[type=\"submit\"]:active {\n  box-shadow: inset 0 1px 3px rgba(0, 0, 0, 0.5);\n}\n\n.copyright {\n  text-align: center;\n}\n\n#contact input:focus,\n#contact textarea:focus {\n  outline: 0;\n  border: 1px solid #aaa;\n}\n\n::-webkit-input-placeholder {\n  color: #888;\n}\n\n:-moz-placeholder {\n  color: #888;\n}\n\n::-moz-placeholder {\n  color: #888;\n}\n\n:-ms-input-placeholder {\n  color: #888;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  -webkit-font-smoothing: antialiased;\n  -moz-font-smoothing: antialiased;\n  -o-font-smoothing: antialiased;\n  font-smoothing: antialiased;\n  text-rendering: optimizeLegibility;\n}\n\n</style>\n      \n</div>\n\n\n        \n      </div>        \n    "]);
...
class ReceiptView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, _Router.anchorRoute);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new ReceiptView();
...
var _confirm = _interopRequireDefault(require("./views/pages/confirm"));

var _receipt = _interopRequireDefault(require("./views/pages/receipt"));
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/test":"views/pages/test.js","./views/pages/location":"views/pages/location.js","./views/pages/products":"views/pages/products.js","./views/pages/contact":"views/pages/contact.js","./views/pages/confirm":"views/pages/confirm.js","./views/pages/receipt":"views/pages/receipt.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
class App {
  constructor() {
    this.name = "Kafe Lakot";
    this.version = "1.0.0";
    this.apiBase = 'https://uhosenbocus-kafelakot-backend.herokuapp.com/';
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2(), this.title) : "", _Router.anchorRoute, _Router.anchorRoute, _Router.anchorRoute, _Router.anchorRoute, e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', this.user && this.user.firstName, () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut(), this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, () => _Auth.default.signOut());
  }
